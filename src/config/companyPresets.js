...
export const COMPANY_PRESETS = {
  eco: {
    ...
    description: 'Impresa edile specializzata in ristrutturazioni civili e commerciali, posa pavimenti, opere murarie e interventi chiavi in mano.',
    logo: ecoLogo,
    address: 'Via Roma, 8',
  ...
  procasaroma: {
    ...
    phone: '+39 334 222 1212',
    email: 'info@posaparquetroma.it',
    website: 'www.posaparquetroma.it',
    vatId: 'DSCNSM87E22Z129B',
    taxId: 'DSCNSM87E22Z129B',
    bankName: '',
    bankBranch: '',
    accountNumber: '',
    iban: 'DSCNDR88R22Z129B',
